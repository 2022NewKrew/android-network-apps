...
import com.example.paging.data.repository.JsonPlaceholderRepositoryImpl
...
abstract class PagingNetworkModule {
    ...
    @Binds
    abstract fun bindJsonPlaceholderRepository(jsonPlaceholderRepositoryImpl: JsonPlaceholderRepositoryImpl): JsonPlaceholderRepository
