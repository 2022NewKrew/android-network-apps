...
import com.survivalcoding.network_apps.di.DataSourceModule.TodoRemoteDataSourceQualifier
...
object RepositoryModule {
    @Provides
    @ViewModelScoped
    fun provideTodoRepository(@TodoRemoteDataSourceQualifier dataSource: TodoDataSource): TodoRepository = TodoRepositoryImpl(dataSource)
